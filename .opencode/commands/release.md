...
3. hacer la release: GITHUB_TOKEN=$(gh auth token) goreleaser release --clean --skip=validate
   - --skip=validate es necesario si el repo tiene cambios sin commit (dirty)
