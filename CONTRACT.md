...
This document defines the runner's responsibilities. AYNIG is a small Git-based
execution kernel: workflows define meaning; the runner provides dispatch,
locking, logging, and state materialization.
