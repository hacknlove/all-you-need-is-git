---
title: Install CLI
description: Install the AYNIG CLI on your machine.
---
...
We publish `.deb` and `.rpm` packages on GitHub Releases: `https://github.com/hacknlove/all-you-need-is-git/releases`.
